...
const handleApiError = (error: unknown): never => {
  if (axios.isAxiosError(error)) {
    ...
    if (axiosError.code === "ERR_NETWORK" || axiosError.code === "ECONNREFUSED" || axiosError.message.includes("Network Error") || axiosError.message.includes("ERR_CONNECTION_REFUSED")) {
